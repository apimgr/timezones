...
// Router interface for compatibility with chi.Router and http.ServeMux
...
<head>
    ...
    <title>Admin Login - Timezones API</title>
    <style>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin Dashboard - Timezones API</title>
    <style>
...
<body>
    <nav class="navbar"><h1>Timezones API Admin</h1><div><a href="/admin/dashboard">Dashboard</a><a href="/admin/settings">Settings</a><a href="/admin/logout">Logout</a></div></nav>
    <div class="container">
        <div class="cards">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Settings - Timezones API</title>
    <style>
